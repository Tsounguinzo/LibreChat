...
function ResetPassword() {
  ...
  if (resetPassword.isSuccess) {
    return (
      <>
        <div
          className="relative mb-8 mt-4 rounded border border-red-400 bg-red-100 px-4 py-3 text-center text-red-700 dark:bg-gray-900 dark:text-white"
          role="alert"
        >
        ...
        <button
          ...
          className="w-full transform rounded-md bg-red-500 px-4 py-3 tracking-wide text-white transition-colors duration-200 hover:bg-red-600 focus:bg-red-600 focus:outline-none"
        >
        ...
        <div className="relative">
          ...
          <input
            ...
            className="
              ...
              bg-surface-primary px-3.5 pb-2.5 pt-3 text-text-primary duration-200 focus:border-red-500 focus:outline-none
           "
            placeholder=" "
          />
          <label
            ...
            className="
              ...
              peer-focus:top-1.5 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 peer-focus:text-red-500
