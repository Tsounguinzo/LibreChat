...
const BodyTextWrapper: FC<{ children: ReactNode }> = ({ children }) => {
  return (
    <div
      className="relative mt-4 rounded border border-red-400 bg-red-100 px-4 py-3 text-red-700 dark:bg-red-900 dark:text-white"
      role="alert"
    >
      {children}
    </div>
...
const ResetPasswordBodyText = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <span>
        <a className="text-sm text-red-500 hover:underline" href="/login">
